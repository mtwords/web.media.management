      ...
      public static void main(String[] args) throws SQLException {
    	  ...
    	  int s;
            ...
            try {
               ...
               psmnt.setString(1,"S01E02 - Quit Smoking");
               ...
               psmnt.setString(4,"O:\\vid\\Serien\\Chuck\\Season 1\\my_name_is_earl.1x02.quit_smoking.dvdrip_xvid-fov.avi");
             ...
             //Bewertung 3
			   ...
			   "values((Select eId from episode where episodeTitle = 'S01E02 - Quit Smoking'),(Select rId from rating where ratedBy = 'BPT' and rating = '4'))");
             ...
             //Bewertung 2
               psmnt = connection.prepareStatement("insert into has(eId, rId) "+
			   "values((Select eId from episode where episodeTitle = 'S01E02 - Quit Smoking'),(Select rId from rating where ratedBy = 'KPT' and rating = '4'))");
             ...
             //Bewertung 3
               psmnt = connection.prepareStatement("insert into has(eId, rId) "+
			   "values((Select eId from episode where episodeTitle = 'S01E02 - Quit Smoking'),(Select rId from rating where ratedBy = 'MCE' and rating = '2'))");
